/**
 * BarAI Desktop v8.1 - Sync cloud + fogli Google leggibili
 *
 * Uso:
 ...
 *    BARAI_SYNC_FOLDER_ID = cartella Drive dove salvare BarAI_Cloud_Snapshot_v8_1.json.
...
const BARAI_SYNC_FILE_NAME = 'BarAI_Cloud_Snapshot_v8_1.json';
