/**
 * BarAI Desktop v8 - Sync cloud + fogli Google leggibili
 *
 * Uso:
 ...
 *    BARAI_SYNC_FOLDER_ID = cartella Drive dove salvare BarAI_Cloud_Snapshot_v7_5_2.json.
...
const BARAI_SYNC_FILE_NAME = 'BarAI_Cloud_Snapshot_v7_5_2.json';
...
const SHEET_DEFS = [
  ...
  { sheet: 'Prima_Nota', table: 'prima_nota', columns: ['id','data_movimento','tipo','conto','categoria','sottocategoria','descrizione','importo','metodo_pagamento','origine','riferimento_tipo','riferimento_id','fornitore_id','fornitore_nome','note','auto_generato','modificabile','created_at','updated_at'] }
];
