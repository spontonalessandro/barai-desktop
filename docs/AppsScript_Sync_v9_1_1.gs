/**
 * BarAI Desktop v9.1.1 - Sync cloud + fogli Google leggibili
 *
 * Uso:
 ...
 *    BARAI_SYNC_FOLDER_ID = cartella Drive dove salvare BarAI_Cloud_Snapshot_v9_1_1.json.
...
const BARAI_SYNC_FILE_NAME = 'BarAI_Cloud_Snapshot_v9_1_1.json';
