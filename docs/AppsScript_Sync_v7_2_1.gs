/**
 * BarAI Desktop v7.2.1 - Sync cloud + fogli Google leggibili
 *
 * Uso:
 ...
 *    BARAI_SYNC_FOLDER_ID = cartella Drive dove salvare BarAI_Cloud_Snapshot_v7_2.json.
...
const BARAI_SYNC_FILE_NAME = 'BarAI_Cloud_Snapshot_v7_2_1.json';
...
const SHEET_DEFS = [
  ...
  { sheet: 'Prima_Nota', table: 'prima_nota', columns: ['id','data_movimento','tipo','categoria','descrizione','importo','metodo_pagamento','riferimento_id','note','created_at','updated_at'] }
];
